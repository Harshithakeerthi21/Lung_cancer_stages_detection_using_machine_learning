# -*- coding: utf-8 -*-
"""Copy of stages95best.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1y48IgasMU8GyrvsesBtdvgGAhkVbn1iq
"""
...
def make_gradcam_heatmap(img_array, model, last_conv_layer_name, pred_index=None):
    # Extract convolutional outputs and model predictions
...
# Function to apply Grad-CAM overlay
def apply_gradcam(image_path, model, last_conv_layer_name, input_size=(224, 224)):
    ...
    img_array_uint8 = np.uint8(255 * img_array[0])  # Convert image to uint8
    overlay = cv2.addWeighted(img_array_uint8, 0.6, heatmap_resized, 0.4, 0)

    return overlay, heatmap_resized

# Example Usage
overlay, heatmap = apply_gradcam("/content/Lung_Cancer_Dataset_Split/test/Stage_3/Malignant case (447).jpg", model, "block14_sepconv2_act")
plt.imshow(overlay)
plt.show()
...
# Define folder paths
folders = ["/content/Lung_Cancer_Dataset_Split/train", "/content/Lung_Cancer_Dataset_Split/test", "/content/Lung_Cancer_Dataset_Split/validation"]
...
# Define folder paths
folders = ["/content/Lung_Cancer_Dataset_Split/train"]
for folder in folders:
    zip_filename = f"{folder}.zip"
